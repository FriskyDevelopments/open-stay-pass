...
const output = `${assets}/folios-v2-open-stay-pass-vertical-b.mp4`;
const inputs = [
  `${assets}/folios-v2-vertical-b-01.mp4`,
  `${assets}/folios-v2-vertical-b-02.mp4`,
  `${assets}/open-stay-pass-hero-score.wav`,
  `${assets}/folios-v2-vertical-b-narration-01.wav`,
  `${assets}/folios-v2-vertical-b-narration-02.wav`,
];
