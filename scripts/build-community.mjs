...
await rm(path.join(output, "design-system", "vercel.json"), { force: true });
...
// No product bundle, API proxy, runtime environment, credential fixture, or Vercel config enters this output.
